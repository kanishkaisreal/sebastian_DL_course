import time
import torch
from custom_dataloader.helper_evaluation import compute_accuracy
from custom_dataloader.helper_evaluation import compute_epoch_loss_classifier
from custom_dataloader.helper_evaluation import compute_epoch_loss_autoencoder
